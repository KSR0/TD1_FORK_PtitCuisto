...
<script src="../../controller/page/script_creation_compte.js"></script>

<h1 class="text-center text-charte_bleu_fonce font-permanent_marker text-5xl mb-5">Création d'un compte</h1>
<p class="text-3xl text-center text-charte_bleu_clair">Page permettant de créer un compte.</p>
