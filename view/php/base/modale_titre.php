<div id="staticModal" data-modal-backdrop="static" aria-hidden="true" class="z-20 modal2 opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
        ...
        <div class="modal2-content py-4 text-left px-6">
            ...
            <form action="filtre_titre.php" method="post">
                <div class="relative">
                    ...
                    <input type="search" id="search" name="titre" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Saisissiez un titre" required>
