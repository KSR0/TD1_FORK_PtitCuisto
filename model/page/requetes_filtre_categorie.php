<?php
    ...
    function recupRecettesCategorie($bdd) {
        if(isset($_POST['list-radio'])) {
            $requete = "SELECT REC_IMAGE, REC_TITRE, CAT_INTITULE, REC_RESUME FROM FORK_RECETTE JOIN FORK_CATEGORIE USING(CAT_ID) WHERE CAT_ID = " . $_POST['list-radio'] . " ORDER BY REC_TITRE ASC" ;
